...
const ContactButton = ({ onClick }: ContactButtonProps ) => {
    return <button onClick={onClick} className="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg_blue-700">Contact</button>;
};

export const UserProfileCard = ({ user, onContactClick }:
